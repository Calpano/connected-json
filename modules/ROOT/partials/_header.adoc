...
:ccj: Canonical CJ
:ecj: Extended CJ
:cj-document: link:spec.adoc#document[CJ:Document]
:cj-id: link:spec.adoc#id[CJ:ID]
:cj-label: link:spec.adoc#label[CJ:Label]
:cj-graph: link:spec.adoc#graph[CJ:Graph]
:cj-node: link:spec.adoc#node[CJ:Node]
:cj-edge: link:spec.adoc#edge[CJ:Edge]
:cj-endpoint: link:spec.adoc#endpoint[CJ:Endpoint]
:cj-port: link:spec.adoc#port[CJ:Port]
:graphml: GraphML
