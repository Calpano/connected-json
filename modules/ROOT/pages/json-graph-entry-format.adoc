...
|\@context| `object` | Optional. Document-level. Documented in xref:spec-cj.adoc#context[CJ Context (Namespace Map)].
...
| @context | CJ: <<document>> namespace map for URI expansion
